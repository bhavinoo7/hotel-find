...
module.exports.rendernewlistingform=(req,res)=>{//if this route use after the  id then error ocuure
    res.render("listings/add.ejs");
};

module.exports.addnewlisting=async(req,res,next)=>{
    //for cordinate
    const resulta = await maptilerClient.geocoding.forward(req.body.listing.location);
...
module.exports.editlisting=async(req,res)=>{//here using second type of serverside validation
